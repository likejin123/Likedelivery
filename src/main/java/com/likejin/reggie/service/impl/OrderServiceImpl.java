...
import com.likejin.reggie.entity.*;
import com.likejin.reggie.exception.MyException;
import com.likejin.reggie.exception.ResponseEnum;
import com.likejin.reggie.mapper.OrderMapper;
import com.likejin.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper,Orders> implements OrderService{
    ...
    public void submit(Orders orders) {
        //addressBookId"1664975345349623810"
        //payMethod1
        //remark
        ...
        if(shoppingCarts == null && shoppingCarts.size() == 0){
            throw new MyException(ResponseEnum.SHOPPINGCART_NULL);
        }
